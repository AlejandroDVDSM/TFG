...
public class QueenMovement : MonoBehaviour, IMovement
{
    ...
    private void CheckTop(List<Vector2Int> availableMoves)
    {
    ...
    private void CheckBottom(List<Vector2Int> availableMoves)
    {
